...
<head>
    ...
    <title>registrasi dua putra</title>
    ...
    <style>
        ...
        body {
            background-image: url("aset/brand/buku.jpg");
        }
...
<body class="text-center">
    ...
    <main class="form-registration">
        ...
        <form method="POST" action="/registrasi" class="lg-3 mt-5">
            @csrf
            ...
            <div class="form-floating">
                <input type="email" class="form-control" id="email" placeholder="masukan Password" name="email"
                    required>
        ...
        <small>sudah punya akun <a href="/masuk">klik login </a></small>
    </main>
